...
| `python-mako` (Mesa meson build) | `python-mako` (or `pip install --user --break-system-packages mako`) | `python3-mako` |
| `python-yaml` / PyYAML (Mesa meson build) | `python-yaml` (or `pip install --user --break-system-packages pyyaml`) | `python3-yaml` |
